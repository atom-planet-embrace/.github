...
| [`ai-fax`](https://github.com/atom-planet-embrace/ai-fax) | 0.2.6 | [![Build Status](https://github.com/atom-planet-embrace/ai-fax/actions/workflows/ci.yml/badge.svg)](https://github.com/atom-planet-embrace/ai-fax/actions) | Decoder and Encoder for CCITT Group 3 and 4 bi-level image encodings used by fax machines TIFF and PDF. |
...
| [`ai-image`](https://github.com/atom-planet-embrace/ai-image) | | [![Build Status](https://github.com/atom-planet-embrace/ai-image/actions/workflows/rust.yml/badge.svg)](https://github.com/atom-planet-embrace/ai-image/actions) | Imaging library. Provides basic image processing and encoders/decoders for common image formats. |
...
| [`ai-qoi`](https://github.com/atom-planet-embrace/ai-qoi-rust) | 0.4.1 | [![Build Status](https://github.com/atom-planet-embrace/ai-qoi-rust/actions/workflows/ci.yml/badge.svg)](https://github.com/atom-planet-embrace/ai-qoi-rust/actions) | VERY fast encoder/decoder for QOI (Quite Okay Image) format |
...
| [`ai-tiff`](https://github.com/atom-planet-embrace/ai-image-tiff) | 0.11.3 | [![Build Status](https://github.com/atom-planet-embrace/ai-image-tiff/actions/workflows/rust.yml/badge.svg)](https://github.com/atom-planet-embrace/ai-image-tiff/actions) | TIFF decoding and encoding library in pure Rust |
...
| [`ai-weezl`](https://github.com/atom-planet-embrace/ai-weezl) | 0.1.12 | [![Build Status](https://github.com/atom-planet-embrace/ai-weezl/actions/workflows/rust.yml/badge.svg)](https://github.com/atom-planet-embrace/ai-weezl/actions) | Fast LZW compression and decompression. |
